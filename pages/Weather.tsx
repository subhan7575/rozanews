      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {data && !loading && (
          <div className="animate-slide-up">
             ...
             {/* 1. Main Stats Card */}
             <div className="relative overflow-hidden rounded-[2rem] md:rounded-[3rem] bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl p-6 md:p-12 text-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10 pt-8 border-t border-white/10">
                   <div className="bg-white/5 rounded-2xl p-4 text-center hover:bg-white/10 transition-colors">
                      ...
                      <p className="text-lg md:text-xl font-bold">{data.windSpeed} <span className="text-xs font-normal opacity-60">km/h</span></p>
                      <p className="text-xs uppercase opacity-50">Wind</p>
                   </div>
                   <div className="bg-white/5 rounded-2xl p-4 text-center hover:bg-white/10 transition-colors">
                      <Droplets className="mx-auto mb-2 opacity-70" size={24} />
                      <p className="text-lg md:text-xl font-bold">{data.humidity}<span className="text-xs font-normal opacity-60">%</span></p>
                      <p className="text-xs uppercase opacity-50">Humidity</p>
                   </div>
                   <div className="bg-white/5 rounded-2xl p-4 text-center hover:bg-white/10 transition-colors">
                      <Umbrella className="mx-auto mb-2 opacity-70" size={24} />
                      <p className="text-lg md:text-xl font-bold">{data.uvIndex}</p>
