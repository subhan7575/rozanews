          ...
          {displayVideos.length === 0 ? (
            <div className="text-center py-20">
              ...
              {searchQuery && (
                <button
                  onClick={clearSearch}
                  className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-full transition-colors"
                >
                  Clear Search
                </button>
              )}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-2">
                      {video.tags?.slice(0, 3).map(tag => (
                        <span
                          key={tag}
                          className="px-2 py-1 bg-gray-800 rounded-full text-xs text-gray-300 hover:bg-gray-700 transition-colors"
                        >
                          {tag}
                        </span>
                      ))}
