...
const About: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto py-12 space-y-20 animate-fade-in px-4">
      <SEO title="About Us - Roza News" description="Learn about Roza News, our mission, values, and the team behind the stories." />
        ...
        <div className="grid md:grid-cols-12 gap-0">
          <div className="md:col-span-5 bg-gradient-to-br from-gray-900 to-gray-800 relative min-h-[300px] flex items-center justify-center">
             ...
             <div className="text-center p-8 relative z-10">
                <div className="w-32 h-32 mx-auto bg-gray-200 rounded-full border-4 border-primary overflow-hidden mb-4 shadow-lg flex items-center justify-center">
                  <span className="text-4xl font-bold text-gray-400">SA</span>
                </div>
