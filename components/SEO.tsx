...
const SEO: React.FC<SEOProps> = ({ 
  ...
  const canonicalUrl = `https://rozanews.com${location.pathname}`;
  ...
  useEffect(() => {
    ...
    updateMeta('keywords', [...keywords, 'Roza News', 'News', 'World Updates', 'Subhan Ahmad'].join(', '));
    ...
    if (type === 'article') {
      schemaData = {
        ...
        "publisher": {
          ...
          "logo": {
            "@type": "ImageObject",
            "url": "https://rozanews.com/logo.png"
          }
        },
        "description": description,
        "mainEntityOfPage": {
