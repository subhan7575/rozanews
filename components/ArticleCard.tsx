...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, onClick, compact }) => {
  ...
  // Handle Video Click (Navigate to Videos page and play specific video)
  ...
  // Helper to get linked video details (thumbnail) if available
    ...
    >
      ...
      >
        ...
        >
           ...
           {/* Floating Category */}
           <span className="absolute top-4 left-4 bg-white/90 dark:bg-black/60 backdrop-blur-md text-gray-900 dark:text-white text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg z-10 border border-white/20 pointer-events-none">
             {article.category}
           </span>

           {/* Hint to scroll if video exists */}
           {linkedVideo && (
