...
import { Menu, X, Search, Sun, Moon, CloudRain, Youtube, Facebook, Linkedin, Twitter } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, toggleTheme, isDark }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top Bar */}
      <div className="bg-dark text-white text-xs py-1 px-4 hidden md:flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <span className="font-semibold text-primary">#GlobalMarkets</span>
          <span className="font-semibold text-blue-400">#TechInnovation</span>
        </div>
      </div>
      ...
      <footer className="bg-dark text-gray-300 py-12 border-t border-gray-800">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="mb-4">
               <Logo className="w-16 h-16 text-white" withText={true} />
            </div>
